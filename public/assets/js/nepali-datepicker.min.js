var NepaliFunctions = function () {
    ...
    function e() {
        ...
        function a(e, t) {
            var n = Date.UTC(e.year, e.month - 1, e.day), r = Date.UTC(t.year, t.month - 1, t.day);
        ...
        function i(e, t) {
            ...
            return n.setDate(n.getDate() + t), {year: n.getFullYear(), month: n.getMonth() + 1, day: n.getDate()}
        }
        ...
        var c = [], m = {year: 2e3, month: 9, day: 17}, h = {year: 1944, month: 1, day: 1};
        ...
        var p = {year: 1970, month: 1, day: 1}, f = {year: 2099, month: 12, day: 30};
        return {
            minDate: e,
            maxDate: t,
            countAdDays: a,
    ...
    function t(e) {
        function t(e) {
            ...
            e.forEach(function (e, t) {
                var n = parseInt(e), a = {index: t, value: n, year: !1, month: !1, day: !1};
        ...
        var n = e.indexOf("/") > -1, r = e.indexOf("-") > -1, a = null;
        if (n) {
            var o = e.split("/");
    ...
    function n(e, t) {
        var n = [], r = {year: null, month: null, day: null};
        switch (t) {
            case"MM/DD/YYYY":
                n = e.split("/"), 3 == n.length && (r = {year: Number(n[2]), month: Number(n[0]), day: Number(n[1])});
                break;
            case"MM-DD-YYYY":
                n = e.split("-"), 3 == n.length && (r = {year: Number(n[2]), month: Number(n[0]), day: Number(n[1])});
                break;
            case"YYYY-MM-DD":
                n = e.split("-"), 3 == n.length && (r = {year: Number(n[0]), month: Number(n[1]), day: Number(n[2])});
                break;
            case"YYYY/MM/DD":
                n = e.split("/"), 3 == n.length && (r = {year: Number(n[0]), month: Number(n[1]), day: Number(n[2])});
                break;
            case"DD-MM-YYYY":
                n = e.split("-"), 3 == n.length && (r = {year: Number(n[2]), month: Number(n[1]), day: Number(n[0])});
                break;
            case"DD/MM/YYYY":
                n = e.split("/"), 3 == n.length && (r = {year: Number(n[2]), month: Number(n[1]), day: Number(n[0])})
        }
    ...
    function i(t) {
        var n = new e, r = n.minDate(), a = n.maxDate();
    ...
    function u() {
        ...
        var t = (e.toDateString(), e.getUTCDate()), n = e.getUTCMonth() + 1;
    ...
    function L(t, n) {
        var r = new e, a = r.minDate(), o = r.maxDate();
    ...
    function U(e, t) {
        ...
        var r = "", a = 0, o = e.toString();
        if (o.indexOf(".") > -1) {
            var i = o.split(".");
            a = Number(i[1])
        }
        var u = Math.floor(e % 100), d = null;
    ...
    function R(e, t) {
        if (i(e) && i(t)) {
            ...
            var n = new Date(e.year, e.month - 1, e.day), r = new Date(t.year, t.month - 1, t.day);
...
!function () {
    ...
    function o(e) {
        var t = {};
        if (Y) a("showNdpCalendarBox"); else {
    ...
    function i(n, r, a) {
        var o = document.getElementById("ndp-nepali-box"), d = b(null), l = "english" == d.language,
            s = o.getElementsByTagName("table")[0].getElementsByTagName("tbody");
        s.length > 0 && s[0].parentNode.removeChild(s[0]);
        var c = d.ndpYearCount || 0, m = document.getElementById("currentMonth");
        m.innerHTML = "";
        ...
        var g = e(n, r), D = t(n, r), N = g.year, A = g.month, M = D.year, Y = D.month,
            B = document.getElementById("ndp-header"), C = document.getElementById("prev");
        ...
        var I = !0;
        d.disableAfter && NepaliFunctions.CompareBsDates({year: N, month: A, day: 1}, d.disableAfter) && (I = !1);
    ...
    function u(e, t, n) {
        var r, a, o, i = b(null), u = "english" == i.language;
        if (n) {
            var d = NepaliFunctions.ConvertToDateObject(n, "YYYY-MM-DD");
            r = d.year, a = d.month, o = d.day
        }
        var l = NepaliFunctions.GetCurrentBsDate(), s = l.year, c = l.month, m = l.day,
            h = NepaliFunctions.GetDaysInBsMonth(e, t), f = {year: e, month: t, day: 1}, y = NepaliFunctions.BS2AD(f),
            v = y.year, g = y.month, D = y.day, N = new Date(v, g - 1, D), A = N.getDay(), M = 0, Y = 0, B = A + h,
            C = "", E = "", F = 0;
    ...
    function d(e) {
        var t = l(e), n = m(t), r = h(e, t), a = document.getElementById("ndp-nepali-box"), o = a.offsetHeight,
    ...
    function p(e) {
        var t = e.getAttribute("data-value"), n = b(), r = NepaliFunctions.ConvertToDateObject(t, n.dateFormat);
    ...
    function f(e, t, n) {
        var r = b(), a = "english" == r.language, o = 1, i = 12;
    ...
    function y(e, t, n, r) {
        var a = b(), o = "english" == a.language, i = 1970, u = 2099;
    ...
    function g(e, t) {
        var n = b(), r = document.getElementById("ndp-year-select"), a = document.getElementById("ndp-month-select"),
            o = parseInt(r.value);
        e = n.ndpMonth ? parseInt(a.value) : e;
        var u = n.disableDaysBefore, d = n.disableDaysAfter;
    ...
    function b(e) {
        var t = {};
        if (e || (e = E), e) {
            var n = C[e], r = n.dateFormat || "YYYY-MM-DD",
    ...
    function D() {
        var e = document.activeElement, t = e.getAttribute("id");
    ...
    function M(e) {
        var t = "english" == e.language, n = document.createElement("DIV");
    ...
    Object.prototype.nepaliDatePicker = function (e) {
        ...
        function l() {
            var e = document.getElementById(E), t = document.activeElement, n = e == t, r = d(t, "ndp-nepali-box"),
        ...
        var p = this;
        if ("remove" != e) {
            if (e = void 0 === e ? {} : e, p.length && p.length > 0) for (var f = 0; f < p.length; f++) s(p[f], e); else s(p, e);
            var y = document.querySelectorAll(".ndp-nepali-calendar");
            if (y.length > 0) for (var f = 0; f < y.length; f++) y[f].addEventListener("mouseenter", n), y[f].addEventListener("mouseleave", r);
            ...
            var v = !1
        } else if (p.length && p.length > 0) for (var f = 0; f < p.length; f++) t(p[f]); else t(p)
    }, Object.defineProperty(Object.prototype, "nepaliDatePicker", {enumerable: !1, value: nepaliDatePicker})
}();
