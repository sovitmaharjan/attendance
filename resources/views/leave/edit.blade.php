                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <select class="form-select mb-2" data-control="select2" name="leave_type_id"
                                        ...
                                        @foreach ($leave_type as $item)
                                            <option value="{{ $item->id }}" {{ $leave->leave_type_id == $item->id ? 'selected' : '' }}>{{ $item->title }}</option>
                                        @endforeach
                                    </select>
                                    @error('leave_type_id')
                                        <div class="fv-plugins-message-container invalid-feedback">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="days_allowed" class="form-control mb-2" placeholder="Number of day(s) allowed"
                                        value="{{ $leave->days_allowed ?? old("days_allowed") }}" required/>
