                                            ...
                                            <div class="d-flex gap-5">
                                                <select class="form-select mb-2" name="prefix" data-control="select2"
                                                    ...
                                                    @foreach(getDynamicValues('prefix') as $prefix)
                                                        <option
                                                            value="{{$prefix->name}}" @selected(old('prefix', $employee->prefix) == $prefix->name)>{{$prefix->name}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                @foreach(getGenders() as $k => $gender)
                                                    <input class="form-check-input" type="radio" name="gender"
                                                           ...
                                                           @checked(old('gender', $employee->gender) == $gender->value) required/>
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <select class="form-select mb-2" name="branch_id" data-control="select2"
                                                ...
                                                @foreach ($branch as $item)
                                                    <option
                                                        value="{{ $item->id }}" {{ old('branch_id', $employee->branch_id) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <select class="form-select mb-2" name="department_id" data-control="select2"
                                                ...
                                                @foreach ($department as $item)
                                                    <option
                                                        value="{{ $item->id }}" {{ old('department_id', $employee->department_id) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <select class="form-select mb-2" name="designation_id"
                                                ...
                                                @foreach ($designation as $item)
                                                    <option
                                                        value="{{ $item->id }}" {{ old('designation_id', $employee->designation_id) == $item->id ? 'selected' : '' }}>{{ $item->title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="fv-row w-100 flex-md-root">
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <select class="form-select mb-2" name="supervisor_id" data-control="select2"
                                                ...
                                                @foreach($supervisors as $supervisor)
                                                    <option
                                                        value="{{$supervisor->id}}" @selected(old('supervisor_id', $employee->supervisor_id) == $supervisor->id)>
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <select class="form-select mb-2" name="status" data-control="select2"
                                                ...
                                                @foreach(getDynamicValues('employee_status') as $k => $employee_status)
                                                    <option
                                                        value="{{$employee_status->name}}" @selected(old('status', $employee->status) == $employee_status->name)>
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <select class="form-select mb-2" name="type" data-control="select2"
                                                ...
                                                @foreach(getDynamicValues('employee_type') as $k => $employee_type)
                                                    <option
                                                        value="{{$employee_type->name}}" @selected(old('type', $employee->type) == $employee_type->name)>
                                                        {{$employee_type->name}}
                                                    </option>
                                                @endforeach
                                            </select>
