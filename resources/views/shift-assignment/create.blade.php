                                ...
                                <div class="mb-10 fv-row">
                                    <div class="d-flex flex-wrap gap-5">
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <div class="d-flex">
                                                <input type="text" class="form-control employee-id" id="employee_id"
                                                        ...
                                                        <div data-repeater-item="" id="init">
                                                            <div class="form-group row mb-5">
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <div class="d-flex">
                                                                        <select class="form-select shift" name="shift"
                                                                ...
                                                                <div class="col-md-2 from">
                                                                    ...
                                                                    <div class="d-flex">
                                                                        <input type="text"
                                                                            class="form-control from_date" date-id="from"
    ...
    <script>
        ...
        $('#shift_repeater').repeater({
            ...
            ready: function() {
                ...
                div.find(".from_date").flatpickr({
                    onChange: function() {
                        div.find('.nep_from_date').val(NepaliFunctions.AD2BS(div.find('.from_date').val()));
                    }
                });
                div.find('.nep_from_date').nepaliDatePicker({
                    ndpYear: true,
                    ndpMonth: true,
                    onChange: function() {
                        div.find('.from_date').val(NepaliFunctions.BS2AD(div.find('.nep_from_date').val()));
                    }
                });
                div.find(".to_date").flatpickr({
                    onChange: function() {
                        div.find('.nep_to_date').val(NepaliFunctions.AD2BS(div.find('.to_date').val()));
                    }
                });
                div.find('.nep_to_date').nepaliDatePicker({
                    ndpYear: true,
                    ndpMonth: true,
                    onChange: function() {
                        div.find('.to_date').val(NepaliFunctions.BS2AD(div.find('.nep_to_date').val()));
                    }
                });
            }
        });
