        ...
        <div class="fv-row w-100 flex-md-root">
            ...
            <div class="d-flex">
                <input type="text" class="form-control from_date" date-id="from"
                    ...
                    autocomplete="off" value="{{ old('from_date', (isset($date->from_date) ? $date->from_date->format('Y-m-d') : '')) }}" required />
            </div>
        </div>
        <div class="fv-row w-100 flex-md-root">
        ...
        <div class="fv-row w-100 flex-md-root">
            ...
            <div class="d-flex">
                <input type="text" autocomplete="off" class="form-control to_date"
                    value="{{ old('to_date', (isset($date->to_date) ? $date->to_date->format('Y-m-d') : '')) }}" date-id="to" placeholder="yyyy-dd-mm"
