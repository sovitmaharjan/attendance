                                    ...
                                    <div class="d-flex flex-wrap gap-5">
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <input type="text" class="form-control mb-2 timepicker"
                                                   placeholder="09:00:00" name="in_time"
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <input type="text" class="form-control mb-2 timepicker"
                                                   placeholder="19:15:00" name="in_time_last"
                                                   value="{{ old('in_time_last') ?? date("h:i", strtotime($shift->in_time_last)) }}"/>
                                            @error('in_time_last')
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="in_time_last"
                                ...
                                <div class="mb-10 fv-row">
                                    <div class="d-flex flex-wrap gap-5">
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <input type="text" class="form-control mb-2 timepicker"
                                                   placeholder="05:00:00" name="out_time"
                                                   value="{{ old('out_time') ?? date("h:i", strtotime($shift->out_time)) }}"/>
                                            @error('out_time')
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="out_time"
                                                     data-validator="notEmpty">{{ $message }}</div>
                                            </div>
                                            @enderror
                                        </div>
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <input type="text" class="form-control mb-2 timepicker"
                                                   placeholder="05:15:00" name="out_time_last"
                                                   value="{{ old('out_time_last') ?? date("h:i", strtotime($shift->out_time_last)) }}"/>
                                            @error('out_time_last')
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="out_time_last"
                                                     data-validator="notEmpty">{{ $message }}</div>
                                            </div>
                                            @enderror
                                        </div>
