                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="text-muted fs-7">A event title is required and recommended to be unique.
                                    </div>
                                    @error("title")
                                    ...
                                    <div class="d-flex flex-wrap gap-5">
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <div class="d-flex gap-5">
                                                <input type="text" class="form-control mb-2 from_date" name="from_date"
                                                       onchange="engtonep($(this), 'nfd')"
                                                       value="{{ $event->from_date ?? old('from_date') }}"
                                                       placeholder="yyyy-dd-mm" id=from_date readonly required/>
                                                <input type="text" class="form-control mb-2" name="nepali_from_date"
                                                       value="{{ $event->extras['nepali_from_date'] ?? old('nepali_from_date') }}"
                                                       placeholder="yyyy-dd-mm" id="nfd" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    @error("from_date")
                                ...
                                <div class="mb-10 fv-row">
                                    <div class="d-flex flex-wrap gap-5">
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <div class="d-flex gap-5">
                                                <input type="text" class="form-control mb-2 to_date" name="to_date"
                                                       onchange="engtonep($(this), 'ntd')"
                                                       value="{{ $event->to_date ?? old('to_date') }}"
                                                       placeholder="yyyy-dd-mm" id=to_date readonly required/>
                                                <input type="text" class="form-control mb-2" name="nepali_to_date"
                                                       value="{{ $event->extras['nepali_to_date'] ?? old('nepali_to_date') }}"
                                                       placeholder="yyyy-dd-mm" id="ntd" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    @error("to_date")
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <select class="form-select mb-2" data-control="select2" name="status"
                                        ...
                                        <option></option>
                                        <option value="1" @selected(old('status', $event->status) == '1')>Active
                                        </option>
                                        <option value="0" @selected(old('status', $event->status) == '0')>Inactive
                                        </option>
                                    </select>
                                    @error('status')
                                    <div class="fv-plugins-message-container invalid-feedback">
