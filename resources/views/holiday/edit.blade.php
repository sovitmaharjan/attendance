                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="name" class="form-control mb-2"
                                           placeholder="Holiday name" value="{{ $holiday->name ?? old('name') }}"
                                           required/>
                                    ...
                                    <div class="d-flex flex-wrap gap-5">
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <input type="text" class="form-control mb-2 from_date" date-id="from"
                                                   ...
                                                   value="{{ $holiday->from_date->format('Y-m-d') ?? old('from_date') }}"
                                                   required>
                                        </div>
                                        @error('from_date')
                                        <div class="fv-plugins-message-container invalid-feedback">
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <input type="text" autocomplete="off" class="form-control mb-2 to_date"
                                                   value="{{ $holiday->to_date->format('Y-m-d') ?? old('to_date') }}"
                                                   date-id="to" placeholder="yyyy-dd-mm" name="to_date" required>
                                        </div>
                                        @error('to_date')
                                        <div class="fv-plugins-message-container invalid-feedback">
...
@section('script')
    <script>
        $(document).on('change', '.from_date, .to_date', function () {
            ...
            $('#quantity').val(days);
            console.log(date1, date2, diffTime, days);
        })
    </script>
@endsection
