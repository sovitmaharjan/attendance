                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="text-muted fs-7">A holiday name is required and recommended to be
                                        unique.
                                    </div>
                                    @error("title")
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <div class="d-flex gap-5">
                                                <input type="text" class="form-control mb-2 from_date" name="from_date"
                                                       ...
                                                       value="{{ old('from_date') }}" placeholder="yyyy-dd-mm"
                                                       id="from_date" readonly required/>
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <div class="d-flex gap-5">
                                                <input type="text" class="form-control mb-2 to_date" name="to_date"
                                                       ...
                                                       value="{{ old('to_date') }}" placeholder="yyyy-dd-mm"
                                                       id="to_date" readonly required/>
