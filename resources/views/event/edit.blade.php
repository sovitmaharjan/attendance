                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <div class="d-flex gap-5">
                                                <input type="text" class="form-control mb-2 from_date" name="from_date" onchange="engtonep($(this), 'nfd')"
                                                    value="{{ $event->from_date ?? old('from_date') }}" placeholder="yyyy-dd-mm" id=from_date readonly required />
                                                <input type="text" class="form-control mb-2" name="nepali_from_date"
                                                    value="{{ $event->extras['nepali_from_date'] ?? old('nepali_from_date') }}" placeholder="yyyy-dd-mm" id="nfd" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    @error("from_date")
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <div class="d-flex gap-5">
                                                <input type="text" class="form-control mb-2 to_date" name="to_date" onchange="engtonep($(this), 'ntd')"
                                                    value="{{ $event->to_date ?? old('to_date') }}" placeholder="yyyy-dd-mm" id=to_date readonly required />
                                                <input type="text" class="form-control mb-2" name="nepali_to_date"
                                                    value="{{ $event->extras['nepali_to_date'] ?? old('nepali_to_date') }}" placeholder="yyyy-dd-mm" id="ntd" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    @error("to_date")
