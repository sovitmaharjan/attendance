        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form id="brand_form" class="form d-flex flex-column flex-lg-row" method="POST"
                    action="{{ route("permission-group.update", $permission_group->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method("put")
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="name" class="form-control mb-2" placeholder="Permission group name"
                                        value="{{ $permission_group->name ?? old("name") }}" required/>
                                    <div class="text-muted fs-7">A permission group name is required and recommended to be unique.
                                    </div>
                                    @error("name")
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route("permission-group.index") }}" id="kt_ecommerce_add_product_cancel"
